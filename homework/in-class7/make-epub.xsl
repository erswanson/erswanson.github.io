...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- The following 6 manifest___ templates are affecting the resulting opf file. -->
    <!-- This type of template is common in XSLT because it keeps __the content__ while removing the container element____. -->
    ...
    <!-- This type of template is also common in XSLT and is an easy way to _leave stuff behind_______. -->
    ...
    <!-- Lots of templates creating __xhtml_____ from the source document. -->
    ...
    <!-- Among the below templates I add a couple classes: __right___ and footnotes_____, so I need to remember to treat them in the CSS.-->
